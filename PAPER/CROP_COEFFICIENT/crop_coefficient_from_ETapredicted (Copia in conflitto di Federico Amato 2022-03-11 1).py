...
et.plot_axis(ax3, [df.index.get_level_values(1), eta_predicted, 'lightgrey'], **fig3_par, legend='ETa Predicted')
et.plot_axis(ax3, [y.index, y, 'lightblue'], plot_type='scatter', size=50, legend='ETa Measured')
et.plot_axis(ax3, [df.index.get_level_values(1), k_total, 'limegreen'], plot_type='scatter', legend='K Predicted (via ETa)')
