...
df_measured = et.make_dataframe(DATABASE, **DATAFRAME_PAR, method='drop')
...
outliers = et.remove_outliers(k_measured.values.reshape(-1,1),
                              k_total.values.reshape(-1,1),
                              'IsolationForest',
                              origin='DataFrame',
                              contamination=0.05)
...
# et.plot_axis(ax3, [df.index, eta_predicted, 'lightgrey'], **fig3_par, legend='ETa Predicted')
# et.plot_axis(ax3, [y.index, y, 'lightblue'], plot_type='scatter', size=50, legend='ETa Measured')
et.plot_axis(ax3, [df.index, k_total, 'limegreen'], plot_type='scatter', legend='K Predicted (via ETa)')
et.plot_axis(ax3, [df_measured.index, k_measured, 'magenta'], plot_type='scatter', size=50, legend='K Measured')
ax3.legend()
