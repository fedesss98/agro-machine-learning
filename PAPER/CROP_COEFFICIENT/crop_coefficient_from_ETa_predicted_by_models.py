...
def plot_kc(data, x, y, hue, theoretical=False, swc=False, **kwargs):
    ...
    if swc:
        ...
        axp.set_xlabel(xlabel, fontsize=26)
        axp.set_ylabel('SWC', fontsize=26)
        axp.tick_params(axis='both', labelsize=18)
    else:
    ...
    ax.legend(loc='upper center', fontsize=18, ncol=2)
    if 'ylim' in kwargs:
